...
optimizer = optim.SGD(network.parameters(), lr=0.01, momentum=0.9, nesterov=True)
...
plt.plot(x, y5, color="r", linestyle="-", marker="o", linewidth=1, label="classes_train")
plt.plot(x, y6, color="b", linestyle="-", marker="o", linewidth=1, label="classes_val")

y7 = Accuracy_list_species["train"]
y8 = Accuracy_list_species["val"]
plt.plot(x, y7, color="r", linestyle="-", marker=".", linewidth=1, label="species_train")
plt.plot(x, y8, color="b", linestyle="-", marker=".", linewidth=1, label="species_val")


plt.legend()
plt.title('train and val Classes & Species acc vs. epoches')
plt.ylabel('Species accuracy')
plt.savefig("train and val Classes & Species acc vs epoches.jpg")
plt.close('all')
